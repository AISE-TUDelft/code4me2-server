...
#     try:
#         user_id = redis_manager.get_user_id_by_auth_token(auth_token)
#         if not user_id:
...
#         session_info = redis_manager.get_session(session_token)
#         if not session_info:
#             return JsonResponseWithStatus(
#                 status_code=401,
...
#         redis_manager.move_session_info_to_db(
#             db=db_session, session_token=session_token
#         )
#         redis_manager.delete_session(session_token)
