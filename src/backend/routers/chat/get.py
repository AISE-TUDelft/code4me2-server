...
def __parse_chat_history(db_session, chat_history_data):
    """
    Helper function to parse chat history data from the database.
    Converts raw data into ChatHistoryResponse format.
    """
    ...
    for chat, chat_conversations in chat_history_data:
        ...
        # Build history items from conversations
        history_items = []
        ...
        for meta_query, context, generations in chat_conversations:
            ...
            user_message = ChatMessageItem(
                ...
                content=context.prefix,  # The user's input is stored in prefix
                timestamp=meta_query.timestamp,
                meta_query_id=meta_query.meta_query_id,
            )

            # Create assistant responses from generations
            assistant_responses = []
        ...
        # Create ChatHistoryResponse for this chat
